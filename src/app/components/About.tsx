...
const About = () => {
  return (
    <section className="mt-[5.5rem] sm:mt-[8.5rem] mb-[10rem] sm:mb-[14rem] max-w">
      <div className="w-full grid  gap-6 md:gap-0 ">
        <div className="flex flex-col md:flex-row w-full gap-6 md:gap-0  ">
          <div className=" md:flex-[0_0_50%] md:mb-[5rem] md:pr-3 ">
            <h3 className="uppercase whitespace-nowrap  text-[2.5rem] sm:text-[4rem] mb-[2rem] sm:mb-[4rem] font-bold inline-flex gap-4">
              About me
              <Image src={ZigZag} alt="ZigZag" className=" hidden xl:block dark:invert-0 invert" />
            </h3>
            <p className=" text-xl md:text-[clamp(22px,_2vw,_36px)] leading-[100%] text-mainGray font-bold dark:text-white  max-w-[42rem]">
              I am a{" "}
        ...
        <div className="flex flex-col md:flex-row items-center justify-center  gap-6 md:gap-0">
          ...
          <div  className="md:flex-[0_0_50%] flex justify-center items-center  pl-3 ">
            <p className="text-xl md:text-[clamp(22px,_2vw,_36px)] text-mainGray leading-[100%] dark:text-white font-bold max-w-[42rem]">
